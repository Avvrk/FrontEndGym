...
async function validarDatos() {
  let verificado = true;
    ...
    if (codigoP.value == "" || descripcionP.value == "" || valorP.value == "" || cantidadP.value == "") {
        $q.notify({
            type: "negative",
...
<div>
        <div class="q-pa-md">
          ...
          <q-table flat bordered title="Lista de Inventario" :rows="rows" :columns="columns" row-key="id">
        ...
        <div id="formularioInventario" v-if="mostrarFormularioInventario == true">
            <q-form @submit="registrar()" @reset="resetear()" class="q-gutter-md">
                ...
                <q-input standout="bg-green text-white" v-model="descripcionP" label="Descripción" color="black" />
                <q-input standout="bg-green text-white" v-model="valorP" label="Valor" color="black" />
                <q-input standout="bg-green text-white" v-model="cantidadP" label="Cantidad" color="black" />
                <div>
