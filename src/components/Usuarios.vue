...
function resetear() {console.log("hola");
    nombreUsuario = ref("");
    correoUsuario = ref("");
    telefonoUsuario = ref("");
...
function editarVistaFormulario(boolean) {
...
<template>
    <div>
        <div class="q-pa-md">
			<div>
				<q-btn @click="editarVistaFormulario(true)"> agregar </q-btn>
			</div>
        ...
        <button id="formularioUsuario" v-if="mostrarFormularioUsuario == true" @click="editarVistaFormulario(false)">
